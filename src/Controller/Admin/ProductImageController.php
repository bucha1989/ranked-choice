...
class ProductImageController extends AbstractController
{
     ...
     */
    public function delete(ProductImage $productImage, ProductManager $productManager, ProductImagesManager $imagesManager): Response
    {
        if (!$productImage) {
        ...
        $imagesManager->removeImageFromProduct($productImage, $productImagesDir);
